...
public class TeamMemEdit extends javax.swing.JFrame {
    ...
    String query = "SELECT employee_id FROM EmployeeList WHERE employee_name = ?";
    ...
    void loadMemberIntoComboBoxes()throws SQLException{
        ...
        try(Connection conn=DBConnection.getConnection();
            ...
            while(rs.next()){
                ...
                String employee_name=rs.getString("team_name");
        ...
        String delSql="select e.epmloyee_name, e.employee_id"
                + " from EmployeeList e join TeamMemberList tm"
                + " on e.employee_id=tm.employee_id"
                + " where tm.team_id=?";
