...
public class TeamMemberInterface extends javax.swing.JFrame {
    ...
    private void btnDataEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDataEditActionPerformed
        // TODO add your handling code here:
        TeamMemEdit teamEdit=new TeamMemEdit();
        teamEdit.setVisible(true);
    }//GEN-LAST:event_btnDataEditActionPerformed

    void loadTeamMembers() {
    if (team_id == null) {
        JOptionPane.showMessageDialog(this, "ID Tim tidak ditemukan!");
        return;
    }
    ...
    String query = "SELECT tm.employee_id, e.employee_name FROM TeamMemberList tm JOIN EmployeeList e"
            + " ON tm.employee_id=e.employee_id WHERE team_id = ?";

    try (Connection conn = DBConnection.getConnection();
         PreparedStatement pstmt = conn.prepareStatement(query)) {

        pstmt.setLong(1, team_id);  // Set teamId ke query
        ...
        try (ResultSet rs = pstmt.executeQuery()) {
            while (rs.next()) {
                ...
                // Tambahkan data ke tabel (atau JList, tergantung komponen yang digunakan)
                Object[] row = {employeeId, employeeName};
                tableModel.addRow(row);
            }
        }
    } catch (SQLException ex) {
        JOptionPane.showMessageDialog(this, "Error saat memuat anggota tim: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    }
    }
